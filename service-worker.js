...
const CACHE_VERSION = 'gradeearn-v161';
...
const SHELL_FILES = [
  ...
  '/js/widgets/svg-helpers.js',
  '/js/widgets/widget-renderer.js',
  '/js/widgets/fraction-bar.js',
  '/js/widgets/number-line.js',
  '/js/widgets/plotter.js',
  '/js/widgets/table.js',
  '/js/widgets/area-model.js',
  '/js/widgets/tape-diagram.js',
  '/js/widgets/base-10-blocks.js',
  '/js/widgets/shape-2d.js',
  '/js/widgets/clock-face.js',
  '/games.html',
