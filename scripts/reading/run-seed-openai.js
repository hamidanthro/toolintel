...
const GK_BRIEFS = [
  ...
  // ----- K v5 — eight more briefs (4 RF + 4 INFO) -----
  { id: 'gk-rf-turtle-on-patio', grade: 'k', genre: 'realistic-fiction',
    topic: 'a kid finds a small box turtle slowly walking across the back patio and squats down to watch it pull its head into the shell',
    setting: 'a Texas backyard patio in summer', protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'gk-rf-summer-sprinkler', grade: 'k', genre: 'realistic-fiction',
    topic: 'a kid runs through a sprinkler in the front yard on a very hot Texas afternoon and laughs every time the cold water surprises them',
    setting: 'a Texas suburb front yard', protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'gk-rf-neighbor-kittens', grade: 'k', genre: 'realistic-fiction',
    topic: 'a kid takes a small bunch of bluebonnets next door to a neighbor whose cat just had three tiny kittens',
    setting: 'a Texas Hill Country street', protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'gk-rf-festival-clap', grade: 'k', genre: 'realistic-fiction',
    topic: 'a kid claps along to a song at a small Texas community festival and notices that everyone around them is clapping too',
    setting: 'a small Texas town festival in the park', protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'gk-info-ladybugs', grade: 'k', genre: 'informational',
    topic: 'ladybugs are tiny red bugs with black spots; they help gardens by eating other tiny bugs that hurt plants',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'gk-info-tx-water-tower', grade: 'k', genre: 'informational',
    topic: 'a water tower is a tall metal tank you can see in many Texas towns; it holds water that comes out of every house\'s faucet when people turn the tap on',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'gk-info-tx-state-instrument', grade: 'k', genre: 'informational',
    topic: 'the guitar is the Texas state instrument; many Texas songs use a guitar, and you can hear guitars at fairs, churches, and front porches all across Texas',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' },
...
const G1_BRIEFS = [
  ...
  // ----- G1 v5 — eight more briefs (4 RF + 4 INFO) -----
  { id: 'g1-rf-lemonade-stand', grade: '1', genre: 'realistic-fiction',
    topic: 'a kid sets up a lemonade stand in front of their house on a hot Texas summer day; they make 4 dollars and learn to count back change for one customer',
    setting: 'a sidewalk in front of a Houston home', protagonistName: 'Jaylen', protagonistDemographic: 'black' },
  { id: 'g1-rf-recess-whistle', grade: '1', genre: 'realistic-fiction',
    topic: "a kid spends three days at recess trying to whistle by copying their friend; finally a tiny whistling sound comes out and they can't wait to show their parents",
    setting: 'a first-grade school playground in Austin', protagonistName: 'Yara', protagonistDemographic: 'middle-eastern' },
  { id: 'g1-rf-mothers-day-card', grade: '1', genre: 'realistic-fiction',
    topic: 'a kid makes a Mother\'s Day card with crayons and glitter glue at school; they fold it carefully so the glitter does not fall off, and write "I love you mom" on the inside',
    setting: 'a first-grade classroom in Dallas', protagonistName: 'Ana', protagonistDemographic: 'hispanic-latino' },
  { id: 'g1-rf-rock-collection', grade: '1', genre: 'realistic-fiction',
    topic: 'a kid finds a smooth white rock near a Texas creek and adds it to a small collection in a shoebox under their bed; they decide to label each rock with the place they found it',
    setting: 'a creek bank near Wimberley', protagonistName: 'Tate', protagonistDemographic: 'unmarked' },
  { id: 'g1-info-tx-state-hat', grade: '1', genre: 'informational',
    topic: 'the cowboy hat is the official Texas state hat (named in 2015); it has a wide brim that keeps the sun off the face and neck and a tall crown that lets warm air rise away from the head',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'g1-info-tx-state-stone', grade: '1', genre: 'informational',
    topic: 'palmwood is the official Texas state stone; it is fossilized wood from palm trees that lived in Texas millions of years ago; rocks of palmwood show the rings and grain of the old wood',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'g1-info-roadrunner-fast', grade: '1', genre: 'informational',
    topic: 'the roadrunner is a Texas bird that prefers to run instead of fly; it can run faster than 20 miles an hour, and it eats lizards, snakes, and bugs in dry parts of West Texas',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' },
  { id: 'g1-info-rattlesnake-rattle', grade: '1', genre: 'informational',
    topic: 'a rattlesnake has a special rattle on the end of its tail; when the snake feels a person or animal getting too close, it shakes the rattle as a warning to "stay back" so it does not have to bite',
    setting: null, protagonistName: null, protagonistDemographic: 'unmarked' }
];
